function [Hi,Gi,VFi]=HGCE(GaussXW,Node,LEC,Mat,AG)
...
%      np=Node(1,1);	En1=Node(2,1);  En2=Node(3,1);    xp=Node(1,2:3)';    
     ...
     %NEE=DLE*[0 -1;1 0];
     %H矩阵
     DLR=[Node(2,2)-Node(1,2) Node(2,3)-Node(1,3)];
     r1=sum(DLR.*DLR,2).^0.5;
     r2=l-r1;
     m1=r2/l*log(r2/r1)-1;m2=r1/l*log(r2/r1)+1;
     HS1= (1-2*NU)/4/pi/(1-NU)*[0 -m1 0 -m2;m1 0 m2 0];
